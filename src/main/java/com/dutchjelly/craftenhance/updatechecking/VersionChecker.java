...
public class VersionChecker {
    ...
    public void runUpdateCheck() {
        ...
        if (!isOutDated(currentVersion)) {
            ...
            Messenger.Message("There's a new version (" + currentVersion + ") of the plugin available on https://www.spigotmc.org/resources/1-9-1-19-custom-recipes-and-crafting-craftenhance.65058/ or https://modrinth.com/plugin/craftenhance/ .");
        }
    }
