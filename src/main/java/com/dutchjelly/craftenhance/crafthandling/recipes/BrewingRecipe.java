...
public class BrewingRecipe extends EnhancedRecipe{
	...
	public Map<String, Object> placeholders(final Player viewer) {
		...
		map.put(InfoItemPlaceHolders.Recipes_activated.getPlaceHolder(), self().getConfig().getBoolean("enable-brewing-recipes") ? "Activated" : "Activate custom brewing in config");
		return map;
	}
